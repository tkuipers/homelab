...
show_next_steps() {
    ...
    echo "3. The 'llama-api-key' secret will be created in the ml-service namespace"
    ...
    echo "  kubectl get externalsecrets -n ml-service"
    echo "  kubectl get secrets -n ml-service"
    echo "  kubectl get pods -n ml-service"
    echo
